...
status_bar = Label(root, text="Image 1 of " + str(len(image_list)), bd=3, relief=SUNKEN, anchor=E)
...
def forward(image_number):
    ...
    status_bar = Label(root, text="Image "+ str(image_number)+" of " + str(len(image_list)), bd=3, relief=SUNKEN, anchor=E)
